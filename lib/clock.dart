      ...
      decoration: new BoxDecoration(
        ...
        boxShadow: [
          new BoxShadow(
            ...
            blurRadius: 0.0,
            color: Colors.green, // widget.shadowColor
          ),
          BoxShadow(
              offset: Offset(0.0, 5.0),
              color: Colors.amber, // widget.circleColor
              // blurRadius: 10,
              spreadRadius: 3),
          BoxShadow(
              offset: Offset(0.0, 4.0),
              color: Colors.blue, // widget.circleColor
              // blurRadius: 2.0,
              spreadRadius: 2),
          BoxShadow(
              offset: Offset(0.0, 1.0),
              color: Colors.pink, // widget.circleColor
              // blurRadius: 2.0,
              spreadRadius: 0),
          BoxShadow(
              offset: Offset(0.0, 2.0),
              color: Colors.green, // widget.circleColor
              // blurRadius: 2.0,
              spreadRadius: 0)
        ],
      ),
